...
-- Started on 2021-12-20 11:51:07
...
--
-- TOC entry 247 (class 1255 OID 17195)
...
--
-- TOC entry 260 (class 1255 OID 18377)
-- Name: musteriekle(character varying, character varying, character varying, character varying, character varying, integer); Type: PROCEDURE; Schema: public; Owner: postgres
--

CREATE PROCEDURE public.musteriekle(IN p_ad character varying, IN p_soyad character varying, IN p_tc_no character varying, IN p_tel character varying, IN p_adres character varying, IN p_siparis_sayisi integer)
    LANGUAGE plpgsql
    AS $$
declare
kontrol varchar;
begin
kontrol := (select tc_no from musteriler where tc_no = p_tc_no);
	if(kontrol=p_tc_no) then 
	raise exception 'Müşteri zaten kayıtlı!!' ;
	else insert into musteriler (ad,soyad,tc_no,tel,adres,siparis_sayisi) values (p_ad,p_soyad,p_tc_no,p_tel,p_adres,p_siparis_sayisi);
	end if;
end;
$$;


ALTER PROCEDURE public.musteriekle(IN p_ad character varying, IN p_soyad character varying, IN p_tc_no character varying, IN p_tel character varying, IN p_adres character varying, IN p_siparis_sayisi integer) OWNER TO postgres;

--
-- TOC entry 259 (class 1255 OID 18376)
...
kontrol varchar;
begin
kontrol := (select tc_no from personeller where tc_no = p_tc_no);
	if(kontrol=p_tc_no) then 
	raise exception 'Personel zaten kayıtlı!!' ;
	else insert into personeller (tc_no,ad,soyad,gorev_no,maas) values (p_tc_no,p_ad,p_soyad,p_gorev_no,p_maas);
	end if;
end;
$$;
...
--
-- TOC entry 243 (class 1255 OID 18354)
...
--
-- TOC entry 248 (class 1255 OID 18324)
...
--
-- TOC entry 258 (class 1255 OID 18350)
...
--
-- TOC entry 249 (class 1255 OID 18330)
...
--
-- TOC entry 3257 (class 2604 OID 17910)
...
--
-- TOC entry 3260 (class 2604 OID 18177)
...
--
-- TOC entry 3262 (class 2604 OID 18239)
...
--
-- TOC entry 3263 (class 2604 OID 18256)
...
--
-- TOC entry 3256 (class 2604 OID 17583)
...
--
-- TOC entry 3249 (class 2604 OID 17048)
...
--
-- TOC entry 3255 (class 2604 OID 17525)
...
--
-- TOC entry 3261 (class 2604 OID 18217)
...
--
-- TOC entry 3248 (class 2604 OID 17034)
...
--
-- TOC entry 3254 (class 2604 OID 17292)
...
--
-- TOC entry 3258 (class 2604 OID 17934)
...
--
-- TOC entry 3250 (class 2604 OID 17076)
...
--
-- TOC entry 3259 (class 2604 OID 18145)
...
--
-- TOC entry 3253 (class 2604 OID 17280)
...
--
-- TOC entry 3474 (class 0 OID 17907)
-- Dependencies: 228
-- Data for Name: admin; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.admin (admin_no, personel_no, username, password) VALUES (8, 1, 'alicetin', '87654321');
INSERT INTO public.admin (admin_no, personel_no, username, password) VALUES (66, 9, 'buse', '123456789');


--
-- TOC entry 3480 (class 0 OID 18174)
-- Dependencies: 234
-- Data for Name: admin_hareketleri; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.admin_hareketleri (hareket_no, admin_no, tarih) VALUES (65, 66, '20.12.2021 06:43:46');
INSERT INTO public.admin_hareketleri (hareket_no, admin_no, tarih) VALUES (29, 8, '19.12.2021 08:53:45');


--
-- TOC entry 3484 (class 0 OID 18236)
-- Dependencies: 238
-- Data for Name: hesaplar; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.hesaplar (hesap_no, siparis_no, odemeturu_no, indirim, toplam_tutar, hesap, tarih, durum) VALUES (59, 1, 1, 0, 16, 16, '20.12.2021 08:47:45', true);
INSERT INTO public.hesaplar (hesap_no, siparis_no, odemeturu_no, indirim, toplam_tutar, hesap, tarih, durum) VALUES (60, 3, 1, 2, 40, 38, '20.12.2021 08:48:22', true);
INSERT INTO public.hesaplar (hesap_no, siparis_no, odemeturu_no, indirim, toplam_tutar, hesap, tarih, durum) VALUES (61, 4, 1, 0, 0, 0, '20.12.2021 08:49:39', false);


--
-- TOC entry 3486 (class 0 OID 18253)
-- Dependencies: 240
-- Data for Name: islemler; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.islemler (islem_no, masa_no, siparis_no, durum) VALUES (37, 9, 3, true);
INSERT INTO public.islemler (islem_no, masa_no, siparis_no, durum) VALUES (38, 7, 4, false);


--
-- TOC entry 3462 (class 0 OID 17080)
-- Dependencies: 216
...
--
-- TOC entry 3472 (class 0 OID 17580)
-- Dependencies: 226
...
INSERT INTO public.masalar (masa_no, durum) VALUES (10, false);
INSERT INTO public.masalar (masa_no, durum) VALUES (9, false);
INSERT INTO public.masalar (masa_no, durum) VALUES (7, true);
INSERT INTO public.masalar (masa_no, durum) VALUES (1, false);
INSERT INTO public.masalar (masa_no, durum) VALUES (5, false);


--
-- TOC entry 3458 (class 0 OID 17045)
-- Dependencies: 212
-- Data for Name: musteriler; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.musteriler (musteri_no, ad, soyad, tc_no, adres, tel, siparis_sayisi) VALUES (9, 'aslı', 'kozan', 'aslı', 'ermenek no:47', '05478412545', 0);
INSERT INTO public.musteriler (musteri_no, ad, soyad, tc_no, adres, tel, siparis_sayisi) VALUES (1, 'aslı', 'bahar', '98765432105', 'karşıyaka mah no:41', '05487541669', 21);


--
-- TOC entry 3470 (class 0 OID 17522)
-- Dependencies: 224
...
--
-- TOC entry 3482 (class 0 OID 18214)
-- Dependencies: 236
-- Data for Name: paket_servis; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.paket_servis (paket_no, musteri_no, personel_no, siparis_no, adres, durum) VALUES (35, 1, 1, 1, 'ermenek no:4', true);


--
-- TOC entry 3456 (class 0 OID 17031)
-- Dependencies: 210
...
INSERT INTO public.personel_gorevleri (gorev_no, gorev_ad) VALUES (5, 'temizlikçi');


--
-- TOC entry 3468 (class 0 OID 17289)
-- Dependencies: 222
-- Data for Name: personeller; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.personeller (personel_no, tc_no, ad, soyad, gorev_no, maas) VALUES (9, '12345678903', 'buse', 'şenöz', 1, 4300);
INSERT INTO public.personeller (personel_no, tc_no, ad, soyad, gorev_no, maas) VALUES (1, '12345678901', 'Ali', 'Çetin', 1, 5500);


--
-- TOC entry 3476 (class 0 OID 17931)
-- Dependencies: 230
-- Data for Name: rezervasyonlar; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.rezervasyonlar (rezervasyon_no, musteri_no, masa_no, tarih, kisi_sayisi) VALUES (15, 1, 10, '24-12-2021', 5);


--
-- TOC entry 3460 (class 0 OID 17073)
-- Dependencies: 214
...
--
-- TOC entry 3478 (class 0 OID 18142)
-- Dependencies: 232
-- Data for Name: siparisler; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.siparisler (siparis_no, urun_no, servisturu_no, adet) VALUES (1, 1, 1, 2);
INSERT INTO public.siparisler (siparis_no, urun_no, servisturu_no, adet) VALUES (3, 1, 1, 5);
INSERT INTO public.siparisler (siparis_no, urun_no, servisturu_no, adet) VALUES (4, 1, 1, 5);


--
-- TOC entry 3466 (class 0 OID 17277)
-- Dependencies: 220
-- Data for Name: stok; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.stok (stok_no, urun_no, adet) VALUES (11, 1, 5);


--
-- TOC entry 3464 (class 0 OID 17264)
-- Dependencies: 218
-- Data for Name: urunler; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public.urunler (urun_no, urun_ad, kategori_no, fiyat) VALUES (2, 'soda', 1, 6);
INSERT INTO public.urunler (urun_no, urun_ad, kategori_no, fiyat) VALUES (1, 'puding', 2, 8);
...
SELECT pg_catalog.setval('public.admin_admin_no_seq', 66, true);
...
SELECT pg_catalog.setval('public.admin_hareketleri_hareket_no_seq', 65, true);
...
SELECT pg_catalog.setval('public.hesaplar_hesap_no_seq', 61, true);
...
SELECT pg_catalog.setval('public.islemler_islem_no_seq', 38, true);
...
SELECT pg_catalog.setval('public.kategoriler_kategori_no_seq', 13, true);
...
SELECT pg_catalog.setval('public.masalar_masa_no_seq', 10, true);
...
SELECT pg_catalog.setval('public.musteriler_musteri_no_seq', 9, true);
...
SELECT pg_catalog.setval('public.paket_servis_paket_no_seq', 35, true);
...
SELECT pg_catalog.setval('public.personel_gorevleri_gorev_no_seq', 5, true);
...
SELECT pg_catalog.setval('public.personeller_personel_no_seq', 32, true);
...
SELECT pg_catalog.setval('public.rezervasyonlar_rezervasyon_no_seq', 15, true);
...
SELECT pg_catalog.setval('public.stok_stok_no_seq', 11, true);
...
--
-- TOC entry 3289 (class 2606 OID 18179)
...
--
-- TOC entry 3283 (class 2606 OID 17912)
...
--
-- TOC entry 3293 (class 2606 OID 18241)
...
--
-- TOC entry 3295 (class 2606 OID 18258)
...
--
-- TOC entry 3271 (class 2606 OID 17085)
...
--
-- TOC entry 3267 (class 2606 OID 17050)
...
--
-- TOC entry 3279 (class 2606 OID 17527)
...
--
-- TOC entry 3291 (class 2606 OID 18219)
...
--
-- TOC entry 3265 (class 2606 OID 17036)
...
--
-- TOC entry 3277 (class 2606 OID 17294)
...
--
-- TOC entry 3285 (class 2606 OID 17936)
...
--
-- TOC entry 3269 (class 2606 OID 17078)
...
--
-- TOC entry 3287 (class 2606 OID 18147)
...
--
-- TOC entry 3275 (class 2606 OID 17282)
...
--
-- TOC entry 3273 (class 2606 OID 17269)
...
--
-- TOC entry 3315 (class 2620 OID 18352)
...
--
-- TOC entry 3312 (class 2620 OID 18289)
...
--
-- TOC entry 3314 (class 2620 OID 18325)
...
--
-- TOC entry 3313 (class 2620 OID 18331)
...
--
-- TOC entry 3304 (class 2606 OID 18180)
...
--
-- TOC entry 3298 (class 2606 OID 17295)
...
--
-- TOC entry 3296 (class 2606 OID 17270)
...
--
-- TOC entry 3301 (class 2606 OID 17942)
...
--
-- TOC entry 3311 (class 2606 OID 18264)
...
--
-- TOC entry 3300 (class 2606 OID 17937)
...
--
-- TOC entry 3306 (class 2606 OID 18225)
...
--
-- TOC entry 3309 (class 2606 OID 18247)
...
--
-- TOC entry 3299 (class 2606 OID 17913)
...
--
-- TOC entry 3305 (class 2606 OID 18220)
...
--
-- TOC entry 3303 (class 2606 OID 18153)
...
--
-- TOC entry 3307 (class 2606 OID 18230)
...
--
-- TOC entry 3308 (class 2606 OID 18242)
...
--
-- TOC entry 3310 (class 2606 OID 18259)
...
--
-- TOC entry 3297 (class 2606 OID 17283)
...
--
-- TOC entry 3302 (class 2606 OID 18148)
...
-- Completed on 2021-12-20 11:51:07
